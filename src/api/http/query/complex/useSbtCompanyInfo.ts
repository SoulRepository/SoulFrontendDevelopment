  ...
  return useMemo(
    () => ({
      ...
      data: {
        ...
        logo: company.logo,
        createAt: sbtCompany.dataSbtCompany.createdAt,
      },
    }),
    [
      ...
      sbtCompany.dataSbtCompany.companies,
      sbtCompany.dataSbtCompany.createdAt,
      companyAdditionalInfo.isSuccess,
      companyAdditionalInfo.isLoading,
      companyAdditionalInfo.isError,
      companyAdditionalInfo.data?.name,
      mainCompany,
      company.name,
